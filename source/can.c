...
/**
 * Inicializa um socketCAN a partir de uma string com o nome
 * @param interface_name nome da inferface
 * @param file_descriptor ponteiro para a variavel onde o file descriptor será salvo
 * @return retorna 0 caso criado com sucesso e 1 caso ocorra erro
 */
